...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Document disputes with landlords, employers, or neighbors. Build a clear, timestamped record you can rely on." },
      { name: "theme-color", content: "#0F1B2D" },
      { property: "og:title", content: "Receipts — Your Personal Paper Trail" },
      { property: "og:description", content: "Document disputes with landlords, employers, or neighbors. Build a clear, timestamped record you can rely on." },
